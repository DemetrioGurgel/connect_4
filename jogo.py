...
def imprime_coordenada():
    ...
    :return: retorna uma linha com a numeração das colunas
    """
    print('\n', end='')
...
def mostra_matriz(tab):
    ...
    :param tab: Tabuleiro
    :return: Exibe o tabuleiro para os jogadores
    """
    imprime_coordenada()
...
def verificar_infinito(jogo, jogador):
    """
    Função que verifica sequências no modo infinito adicionando os pontos em contadores
    :param jogo: Tabuleiro
