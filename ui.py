    ...
    while True:
        ...
        if continuar == "1":
            if banco_de_dados.verifica_memoria():
                ...
                print(colored("Não foram encontrados dados, por favor selecione para jogar um novo jogo", "red"))
        elif continuar == "2":
...
def main_infinito():
    ...
    while not constantes.ganhou:
        ...
        if constantes.turno == JOG1:
            verificar_infinito_y(constantes.jogo, constantes.turno)
        else:
            verificar_infinito_red(constantes.jogo, constantes.turno)
